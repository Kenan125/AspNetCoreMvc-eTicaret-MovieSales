...
namespace AspNetCoreMvc_eTicaret_MovieSales.Data
{
    public class MovieDbContext :DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>().Property(m => m.IsPopular).HasDefaultValue(true);
            modelBuilder.Entity<Movie>().Property(m => m.ImageUrl).HasDefaultValue("./images/filmadi.jpg");

            //Seed Data
            modelBuilder.Entity<Genre>().HasData(
                new Genre() { Id=1,Name="Komedi",Description="Komik olaylar"},
                new Genre() { Id = 2, Name = "Savaş", Description = "Tarihi Savaşlar" },
                new Genre() { Id = 3, Name = "Romantik Komedi", Description = "Komik olaylar" },
            ...
            modelBuilder.Entity<Movie>().HasData
                ...
                new Movie() { Id = 2, Name = "Baskın", Director = "Gareth Evans", Cast = "Anda George, Donny Alamsyah", Stock = 6, Price = 400, Summary = "Operasyon timinin uyuşturucu baskınları", GenreId = 8 },
                ...
                new Movie() { Id = 4, Name = "Figt Club", Director = "David Lyinch", Cast = "Bradd Pitt, Edward Norton", Stock = 5, Price = 450, Summary = "Dövüş kulübü, ilk kural bahsetmemek", GenreId = 8 },
