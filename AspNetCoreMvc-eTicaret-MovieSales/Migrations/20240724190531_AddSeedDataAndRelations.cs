        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Komik olaylar", "Romantik Komedi" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Bradd Pitt, Orlando Bloom", "Wolfgan Pettersen", 2, false, "Truva", 450m, new DateTime(2024, 7, 24, 22, 5, 31, 451, DateTimeKind.Local).AddTicks(3108), 5, "Tarihi Truva savaşından kesitler" },
                    { 2, "Anda George, Donny Alamsyah", "Gareth Evans", 8, false, "Baskın", 400m, new DateTime(2024, 7, 24, 22, 5, 31, 451, DateTimeKind.Local).AddTicks(3127), 6, "Operasyon timinin uyuşturucu baskınları" },
                    { 3, "Leonardo Di Caprio, Cate Winslet", "James Cameron", 4, false, "Titanic", 500m, new DateTime(2024, 7, 24, 22, 5, 31, 451, DateTimeKind.Local).AddTicks(3129), 15, "Lüks titanic gemisinin hazin öyküsü" },
                    { 4, "Bradd Pitt, Edward Norton", "David Lyinch", 8, false, "Figt Club", 450m, new DateTime(2024, 7, 24, 22, 5, 31, 451, DateTimeKind.Local).AddTicks(3131), 5, "Dövüş kulübü, ilk kural bahsetmemek" },
                    { 5, "Bradd Pitt, Christoph Walls", "Quantin Tarantino", 2, false, "Soysuzlar Çetesi", 520m, new DateTime(2024, 7, 24, 22, 5, 31, 451, DateTimeKind.Local).AddTicks(3132), 10, "2. Dünya savaşından kesitler" }
                });
